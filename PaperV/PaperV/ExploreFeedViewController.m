...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.exploreAvatar setImage:image];
    cell.exploreAvatar.layer.cornerRadius = cell.exploreAvatar.frame.size.width / 2;
    cell.exploreAvatar.layer.masksToBounds = YES;
