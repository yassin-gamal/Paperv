...
- (void)viewDidLoad
{
    ...
    //fetch the feed
    NSString *url = [NSString stringWithFormat:@"http://paperv.com/api/home.php?user_id=%@&page=%ld", user_id, (long)pageNumber];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.totalLike.text = [NSString stringWithFormat:@"%ld", (long)storyData.total_like];
    cell.totalComment.text = [NSString stringWithFormat:@"%ld", (long)storyData.total_comment];
    cell.totalRepost.text = [NSString stringWithFormat:@"%ld", (long)storyData.total_repost];
