...
@implementation LikesFeedViewController
...
- (void)viewDidLoad
{
    ...
    //fetch the feed
    NSString *url = [NSString stringWithFormat:@"http://paperv.com/api/user_likes.php?user_id=%@&page=%d", user_id, pageNumber];
